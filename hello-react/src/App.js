...
function App() {
  ...
  const [loginChecked, setLoginCheck] = useState(false);
      ...
      <body>
        <header>
          <div className="header-inner">
            <h1>
              <a href="#!">
                <span className="hidden">SOCAR</span>
              </a>
                ...
                <g>
                  <g>
                    ...
                    <g>
                      <path
                        className="st0"
                        d="M8.2,9.4c0-3.6,9.4-3.6,11.4,1l5.3-3C23.5,3.9,18.2,0.8,13,0.8C6.8,0.8,1.6,4,1.6,9.7
                    ...
                    <path
                      className="st0"
                      d="M153,20.2l0.6-0.3c2.9-1.7,4.5-4.7,4.5-8.1c0-6-4.4-10.2-10.7-10.2h-14.2v29.3h6.7v-9.4h6.5l5.4,9.4h7.5
        ...
        <LoginCheck 로그인여부={loginChecked}></LoginCheck>
        <button
          onClick={() => {
            setLoginCheck(!loginChecked);
          }}
        >
          {loginChecked ? "로그아웃" : "로그인"}
        </button>
        ...
        {/* settimeout과 useState 이용해서 만들어 보도록 합시다 ! */}
        ...
        <main>
          ...
          <section id="start-together">
            ...
            <p>
              <span className="point-blue count-up">8,286,684</span>명의 회원이
              쏘카와
              <br />
              함께하고 있습니다.
              <br />
        ...
        <footer>
          <div className="footer-container">
              ...
              <a href="#!">
                ...
                >
                  <g
                    id="그룹_553"
                    data-name="그룹 553"
                    transform="translate(5481 -4830)"
                  >
                    <g
                      id="그룹_502"
                      data-name="그룹 502"
                      transform="translate(-5544 -93)"
                    >
                      <g
                        id="그룹_109"
                        data-name="그룹 109"
                        transform="translate(63.654 4923.808)"
                      >
                        <g
                          id="그룹_86"
                          data-name="그룹 86"
                        ...
                        >
                          <rect
                            ...
                            height="31"
                            rx="15.5"
                            transform="translate(0.346 0.192)"
                            fill="none"
                            stroke="#646f7c"
                            stroke-width="2"
                          />
                      ...
                      <g
                        id="iconfinder_038_011_instagram_mobile_photo_network_android_material_1646917"
                      ...
                      >
                        ...
                        <path
                          ...
                          transform="translate(-0.251 -0.251)"
                          fill="#646f7c"
                        />
                        <circle
                          id="타원_2072"
                          ...
                          cy="0.944"
                          r="0.944"
                          transform="translate(14.991 6.116)"
                          fill="#646f7c"
                        />
                      </g>
                    </g>
              ...
              <a href="#!">
                ...
                >
                  <g
                    id="그룹_554"
                    data-name="그룹 554"
                    transform="translate(5481 -4768.192)"
                  >
                    <g
                      id="그룹_109"
                      data-name="그룹 109"
                      transform="translate(-5480.346 4769)"
                    >
                      <g
                        id="그룹_86"
                        data-name="그룹 86"
                      ...
                      <g
                        id="iconfinder_square-facebook_317727"
                        transform="translate(11.882 9.053)"
                      >
                        <path
                          id="f"
              ...
              <a href="#!">
                ...
                >
                  <g
                    id="그룹_555"
                    data-name="그룹 555"
                    transform="translate(5488 -4905.192)"
                  >
                    <g
                      id="그룹_110"
                      data-name="그룹 110"
                      transform="translate(-5486.692 4906)"
                    >
                      <g
                        id="그룹_85"
                        data-name="그룹 85"
                      ...
                      >
                        <rect
                          ...
                          height="31"
                          rx="15.5"
                          transform="translate(-0.308 0.192)"
                          fill="none"
                          stroke="#646f7c"
                          stroke-width="2"
                        />
                      ...
                      <g
                        id="iconfinder_icon-social-youtube_211929"
                        transform="translate(12.191 10.172)"
                      >
                        <path
                          id="패스_49"
                          data-name="패스 49"
                          d="M11.316,80.606v-11.5L19.8,74.854Z"
                          transform="translate(-11.316 -69.109)"
                          fill="#646f7c"
                        />
                      </g>
                    </g>
              ...
              <a href="#!">
                ...
                >
                  <g
                    id="그룹_556"
                    data-name="그룹 556"
                    transform="translate(5425 -4952)"
                  >
                    <g
                      id="그룹_26"
                      data-name="그룹 26"
                      transform="translate(-5424 4953)"
                    >
                      <path
                        id="패스_84"
                        data-name="패스 84"
                      ...
                      <path
                        ...
                        transform="translate(-350.439 -227.498)"
                        fill="#646f7c"
                      />
                    </g>
                  </g>
            ...
            <nav>
              ...
              <a href="#!">나눔카</a>
              <a href="#!">이용약관</a>
              <a href="#!" className="important-information">
                개인정보처리방침
              </a>
              <a href="#!" className="important-information">
                위치정보 이용약관
